...
class StateCalculatorTest {
    ...
    void computeForSun() throws JplException {
        ...
        System.out.printf("Sun coords [km]: %s, distance=%f%n", coordsKm, coordsKm.length());
    ...
    void computeForVenusWithVariousTimeSpanPoints() throws JplException {
        ...
        System.out.printf("Venus coords [km] for %.1f [JDE]: %s, distance=%f%n", beginningJde, beginningCoordsKm, beginningCoordsKm.length());
        ...
        System.out.printf("Venus coords [km] for %.1f [JDE]: %s, distance=%f%n", middleJde, middleCoordsKm, middleCoordsKm.length());
        ...
        System.out.printf("Venus coords [km] for %.1f [JDE]: %s, distance=%f%n", endingJde, endingCoordsKm, endingCoordsKm.length());
    ...
    void computeForVenus() throws JplException {
        ...
        System.out.printf("T [JDE]: %f%n", jde);
        System.out.printf("Venus coords [km]: %s, distance=%f%n", coordsKm, coordsKm.length());
    ...
    void computeForMercuryToVenus() throws JplException {
        ...
        System.out.printf("Mercury coords [km]: %s, distance=%f%n", mercuryCoordsKm, mercuryCoordsKm.length());
        ...
        System.out.printf("Venus coords [km]: %s, distance=%f%n", venusCoordsKm, venusCoordsKm.length());

        final RectangularCoordinates venusMercurycentricCoords = venusCoordsKm.subtract(mercuryCoordsKm);
        System.out.printf("Venus from Mercury coords [km]: %s, distance=%f%n", venusMercurycentricCoords, venusMercurycentricCoords.length());
    ...
    void computeForEarthAndCompareWithVSOP() throws JplException, VSOPException {
        ...
        System.out.printf("Earth VSOP87 coords: %s, distance=%f%n", earthVSOPRectCoords, earthVSOPRectCoords.length());
        ...
        final RectangularCoordinates earthJPLCoordsAu = earthJPLCoordsKm.divideBy(this.spKernel.getConstant(JplConstantEnum.AU));
        System.out.printf("Earth JLP coords: %s, distance=%f%n", earthJPLCoordsKm, earthJPLCoordsKm.length());
        ...
        final RectangularCoordinates moonGeocentricJplCoordsAu = moonGeocentricJplCoordsKm.divideBy(this.spKernel.getConstant(JplConstantEnum.AU));

        System.out.printf("Moon JLP coords [AU]: %s, distance=%f%n", moonGeocentricJplCoordsAu, moonGeocentricJplCoordsAu.length());
        System.out.printf("Moon JLP coords [km]: %s, distance=%f%n", moonGeocentricJplCoordsKm, moonGeocentricJplCoordsKm.length());

        final double earthToBarycenterDistance = moonGeocentricJplCoordsKm.length() / (1 + this.spKernel.getConstant(JplConstantEnum.EarthMoonMassRatio));
    ...
    void computeForMoonFromEarth() throws JplException {
        ...
        System.out.printf("Moon coords [km]: %s, distance=%f%n", moonCoordsKm, moonCoordsKm.length());
    ...
    void computeForMars() throws JplException {
        ...
        System.out.printf("Mars coords [AU]: %s, distance=%f%n", coordsKm, coordsKm.length());
