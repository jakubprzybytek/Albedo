...
public class StateSolverFactoryTest_AberrationCorrecting {
    ...
    private static void setup() throws JplException {
        ...
        final SpkKernelCollection third = new SpkKernelCollection("Test", JplBody.Moon, JplBody.EarthMoonBarycenter, ReferenceFrame.J2000, thirdChebyshevList, Collections.emptyList());
