...
public class ConjunctionEventsFilter implements Predicate<Conjunction<BodyDetails, BodyDetails>> {

    final private boolean filterBlindedBySun;

    public ConjunctionEventsFilter(boolean filterBlindedBySun) {
