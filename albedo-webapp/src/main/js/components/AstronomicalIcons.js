...
export function SunIcon({ width, height }) {
  return (
...
export function MoonIcon({ width, height }) {
  return (
    <svg viewBox="0 0 50 50" width={width} height={height} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
export function MercuryIcon({ width, height }) {
  return (
    <svg viewBox="0 0 50 50" width={width} height={height} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
export function VenusIcon({ width, height }) {
  return (
...
export function MarsIcon({ width, height }) {
  return (
    <svg viewBox="0 0 50 50" width={width} height={height} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
export function JupiterIcon({ width, height }) {
  return (
    <svg viewBox="0 0 50 50" width={width} height={height} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
export function SaturnIcon({ width, height }) {
  return (
    <svg viewBox="0 0 50 50" width={width} height={height} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
export function NeptuneIcon({ width, height }) {
  return (
    <svg viewBox="0 0 50 50" width={width} height={height} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
export function UranusIcon({ width, height }) {
  return (
    <svg viewBox="0 0 50 50" width={width} height={height} version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
export function PlanetIcon({ planetName, width, height }) {
  switch (planetName) {
    case 'Mercury':
...
export function CometIcon({ width, height }) {
  return (
