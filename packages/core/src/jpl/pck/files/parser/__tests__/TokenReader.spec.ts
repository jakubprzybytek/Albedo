...
describe("TokenReader", () => {
    it("should read tokens from stream", async () => {
        ...
        expect((await tokens.next()).value).toStrictEqual({ value: "(", lineNumber: 1, line: "  BODY399_RADII     = ( 6378.1366   6378.1366 " });
        expect((await tokens.next()).value).toStrictEqual({ value: "6378.1366", lineNumber: 1, line: "  BODY399_RADII     = ( 6378.1366   6378.1366 " });
        expect((await tokens.next()).value).toStrictEqual({ value: "6378.1366", lineNumber: 1, line: "  BODY399_RADII     = ( 6378.1366   6378.1366 " });
        expect((await tokens.next()).value).toStrictEqual({ value: "6356.7519", lineNumber: 2, line: "  6356.7519 )" });
        expect((await tokens.next()).value).toStrictEqual({ value: ")", lineNumber: 2, line: "  6356.7519 )" });
