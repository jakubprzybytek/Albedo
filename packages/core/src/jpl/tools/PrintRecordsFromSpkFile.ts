...
import { JplBody, jplBodyFromString, EphemerisSeconds } from "@jpl";
import { readSpkFileInformation, readSpkPositionChebyshevPolynomials, readSpkPositionAndVelocityChebyshevPolynomials, DataType } from "@jpl/kernels/spk/files";
...
program
  ...
  .action((fileName: string, options: { body: string, centerBody: string, from: string, to: string }) => {
