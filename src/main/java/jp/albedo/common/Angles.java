...
public class Angles {
    ...
    static double fromHours(int hours, int minutes, double seconds) {
        return Math.toRadians((hours + minutes / 60.0 + (seconds / 3600.0)) * 15.0);
    }

    static double fromDegrees(int degrees, int minutes, double seconds) {
     ...
     */
    static public double separation(AstronomicalCoordinates first, AstronomicalCoordinates second) {
